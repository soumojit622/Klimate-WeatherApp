...
export function WeatherForecast({ data }: WeatherForecastProps) {
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle className="text-center text-lg md:text-xl lg:text-2xl">5-Day Forecast</CardTitle>
            </CardHeader>
            <CardContent>
                <div className="grid gap-4">
                    {nextDays.map((day) => (
                        <div
                            key={day.date}
                            className="grid grid-cols-1 sm:grid-cols-3 items-center gap-4 rounded-lg border p-4 md:p-6"
                        >
                            <div>
                            ...
                            <div className="flex sm:justify-center gap-4">
                                <span className="flex items-center text-blue-500">
                                    <ArrowDown className="mr-1 h-4 w-4 sm:h-5 sm:w-5" />
                                    {formatTemp(day.temp_min)}
                                </span>
                                <span className="flex items-center text-red-500">
                                    <ArrowUp className="mr-1 h-4 w-4 sm:h-5 sm:w-5" />
